...
class RectangularRoom(object):
    ...
    def getNumCleanedTiles(self):
        ...
        returns: an integer
        """
        #Returns the number of True in the tiles dict
...
class StandardRobot(Robot):
    ...
    def updatePositionAndClean(self):
        ...
        been cleaned.
        """
        pos = self.getRobotPosition().getNewPosition(self.getRobotDirection(), self.getSpeed())
...
def runSimulation(num_robots, speed, width, height, min_coverage, num_trials,
    ...
    for i in xrange (num_trials):
        ...
        while not cleanedFor(room, min_coverage):
            time_steps[i] += 1
            for robot in robots:
...
def cleanedFor(room, coverage = 1):
    '''
    Returns True if coverage % of the room is cleaned
    :param coverage:
    :return:
    '''
    cleaned = float(room.getNumCleanedTiles())/room.getNumTiles()
